...
- [ ] 참고문헌 [5] 저장소 URL (공개 후)
- [ ] 참고문헌 [6] 국내 공공데이터 품질·활용 선행연구 1–2편 — **저자가 직접 채워야 한다.**
      지어낸 인용을 넣지 않으려고 자리표시자로 남겼다. [1][2]는 실재 확인함
      (CIDR 2021 / PVLDB 13(12) 3411–3424).
...
한글 9pt를 정폭으로 두고 문단마다 줄 수를 세면 본문 6,543자가 127줄, 표 4개가
18행이다. 여기에 문단 간격을 더하면 **약 2.7쪽**이 된다.

규정(2–3쪽) 상한에 가까우므로 특히 확인이 필요하다 — 넘치면 3.1절의 원인
설명이나 4절의 외적 타당도 단락을 먼저 줄이면 된다.
